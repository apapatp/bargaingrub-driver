...
html+='<b>'+val.delivery_time+'</b> <span class="tag '+val.trans_type_raw+'">'+val.trans_type+'</span>';
			              ...
			              if ( val.order_id>0){
							 ...
							 /*html+='<p><b>'+ getTrans("Merchant ID","merchant_id") +". "+val.merchant_id+'</b></p>';*/
			                 html+='</div>';
			                 html+='</div>';
...
{
	//alert("iner" + data.distance_miles);
	if(empty(data)){
		return '';
	}
	var html='';
	...
	html+='<ons-col width="90%" >     ';            
         html+='<div class="table">';
             ...
             html+='</div>';
             html+='<div class="col">';
             html+='<b>' + 'Total Earnings' + '</b>';
             html+='<p class="concat-text"><b>Total Earnings : '+ data.distance_miles+'</b></p>';
             html+='</div>';
          html+='</div> ';
    html+='</ons-col>';
